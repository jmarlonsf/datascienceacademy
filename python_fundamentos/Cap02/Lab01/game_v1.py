...
from tkinter import *
# import classe randomica
import random
# import time
import time

# variavel que recebe um valor do nível do jogo
level = int(input("Qual nível você gostaria de jogar? 1/2/3/4/5 \n"))
# variável que calcula o tamanho do nível com base no valor escolhido
length = 500/level

# variavel que inicializa objeto TK()
root = Tk()
# titulo
